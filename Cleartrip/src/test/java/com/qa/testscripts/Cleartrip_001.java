...
public class Cleartrip_001 extends TestBase{
	...
	{
		String xFile="C:\\Users\\Jothi\\Downloads\\cleartrip\\src\\test\\java\\com\\qa\\testdata\\Book1.xlsx";
	...
	public void getTest(String Source, String Destination ) throws IOException, InterruptedException, AWTException 
	{
		...
		Cleartrip_Element.firstdropdown.click();
		Thread.sleep(2000);
		Cleartrip_Element.roundtrip.click();
		Thread.sleep(2000);
		Cleartrip_Element.seconddropdown.click();
		Thread.sleep(2000);
		Cleartrip_Element.adult.click();
		Thread.sleep(2000);
		Cleartrip_Element.adultless.click();
		Thread.sleep(2000);
//		Cleartrip_Element.children.click();
//		Thread.sleep(2000);
//		Cleartrip_Element.Infants.click();
//		Thread.sleep(2000);
		Cleartrip_Element.businessclass.click();
		Thread.sleep(2000);
		Cleartrip_Element.sourcedatelink.click();
		Thread.sleep(2000);
		Cleartrip_Element.sourcedate.click();
		Thread.sleep(2000);
